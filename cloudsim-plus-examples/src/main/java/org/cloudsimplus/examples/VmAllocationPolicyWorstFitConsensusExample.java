...
public class VmAllocationPolicyWorstFitConsensusExample {
    ...
    public static void main(String[] args) {
        new VmAllocationPolicyWorstFitConsensusExample();
    }

    private VmAllocationPolicyWorstFitConsensusExample() {
    ...
    private Datacenter createDatacenter() {
        ...
        return new DatacenterSimple(simulation, hostList, new VmAllocationPolicyWorstFitConsensus());
    }
