...
public class VmAllocationPolicyBestFitConsensusExample {
    ...
    public static void main(String[] args) {
        new VmAllocationPolicyBestFitConsensusExample();
    }

    private VmAllocationPolicyBestFitConsensusExample() {
    ...
    private Datacenter createDatacenter() {
        ...
        return new DatacenterSimple(simulation, hostList, new VmAllocationPolicyBestFitConsensus());
    }
